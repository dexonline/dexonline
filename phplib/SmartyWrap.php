    ...
    foreach (func_get_args() as $id) {
      switch($id) {
        ...
        case 'elfinder':
          ...
          break;
        case 'zepu':                self::$cssFiles[9] = 'zepu.css'; break;
        case 'polar':               self::$cssFiles[10] = 'polar.css'; break;
        ...
        case 'flash':               self::$cssFiles[19] = 'flash.css'; break;
        case 'meaningTree':         self::$cssFiles[20] = 'meaningTree.css'; break;
        default:
...
static function addJs(/* Variable-length argument list */) {
    ...
    foreach (func_get_args() as $id) {
      switch($id) {
        ...
        case 'meaningTree':      self::$jsFiles[24] = 'meaningTree.js'; break;
        default:
