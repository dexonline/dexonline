...
{block name=content}
  ...
  <p>
    ...
    unui anumit scop. Citiți Licența Publică Generală GNU pentru detalii.  Puteți găsi o copie a Licenței Publice Generale GNU <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0.html">aici</a> și o traducere a ei în limba română <a href="https://ro.wikipedia.org/wiki/GPL_%28licen%C8%9B%C4%83,_versiunea_2%29">aici</a>.
  </p>
  ...
  <p>
    ...
    dorim să ne substituim autorilor originali ai dicționarelor incluse. Precizăm din nou că <em>dexonline</em> este doar o copie online a DEX, ediția 1998
    ...
    baza de date a <em>dexonline</em>.
  </p>

  În cazul în care doriți să preluați definiții din <em>dexonline</em>, licența GPL vă obligă la două lucruri:
