...
<table class="lexemModel">
  ...
  <tr>
    ...
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[25]|default:null}
    </td>
    <td colspan="2" class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[31]|default:null}
    </td>
  </tr>
  <tr>
    ...
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[26]|default:null}
    </td>
    <td colspan="2" class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[32]|default:null}
    </td>
  </tr>
  <tr>
    ...
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[21]|default:null}
    </td>
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[27]|default:null}
    </td>
    <td colspan="2" class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[33]|default:null}
    </td>
  </tr>
  <tr>
    ...
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[22]|default:null}
    </td>
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[28]|default:null}
    </td>
    <td colspan="2" class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[34]|default:null}
    </td>
  </tr>
  <tr>
    ...
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[23]|default:null}
    </td>
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[29]|default:null}
    </td>
    <td colspan="2" class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[35]|default:null}
    </td>
  </tr>
  <tr>
    ...
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[24]|default:null}
    </td>
    <td class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[30]|default:null}
    </td>
    <td colspan="2" class="form">
      {include file="bits/ifArray.tpl" ifArray=$ifMap[36]|default:null}
    </td>
  </tr>
</table>
